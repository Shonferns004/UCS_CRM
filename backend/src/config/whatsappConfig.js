...
const whatsappConfig = {
  ...
  supabaseFunctionUrl: process.env.WHATSAPP_SUPABASE_FUNCTION_URL,
  supabaseFunctionUrlFallback: process.env.WHATSAPP_SUPABASE_FUNCTION_URL_FALLBACK,
  supabaseApiKey: process.env.WHATSAPP_SUPABASE_API_KEY,
