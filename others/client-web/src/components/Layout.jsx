...
const backRoutes = ['/scanner', '/raise-ticket', '/edit-profile', '/payslip', '/notices', '/holidays']
...
export default function Layout() {
  ...
  const sidebarLinks = [
    ...
    { to: '/attendance', label: 'Attendance', icon: ClockIcon },
    { to: '/payslip', label: 'Payslip', icon: WalletIcon },
...
function WalletIcon({ className }) {
  return <svg width={18} height={18} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 7V5a2 2 0 00-2-2H4a2 2 0 00-2 2v14a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2h-2"/><rect x="14" y="11" width="8" height="4" rx="1"/><line x1="18" y1="11" x2="18.01" y2="11"/></svg>
}
function MegaphoneIcon({ className }) {
  return <svg width={18} height={18} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 11l18-5v12L3 13v-2z"/><path d="M11.6 16.8a3 3 0 11-5.8-1.6"/></svg>
}
function CalendarIcon({ className }) {
  return <svg width={18} height={18} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
}
