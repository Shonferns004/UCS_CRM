export function Icon({ name, size = 18, color = 'currentColor' }) {
  ...
  switch (name) {
    ...
    case 'alarm':
      return <svg {...p}><circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15 14"/><path d="M3.5 5.5L6 3M20.5 5.5L18 3"/></svg>
    case 'list':
    ...
    case 'wifi':
      return <svg {...p}><path d="M1.42 9a16 16 0 0 1 21.16 0"/><path d="M5 12.55a11 11 0 0 1 14.08 0"/><path d="M8.53 16.11a6 6 0 0 1 6.95 0"/><circle cx="12" cy="20" r="1"/></svg>
    case 'globe':
    ...
    case 'car':
      return <svg {...p}><path d="M5 17h14M5 17a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2M5 17l-1 3m15-3l1 3"/><circle cx="7.5" cy="13.5" r="1.5"/><circle cx="16.5" cy="13.5" r="1.5"/></svg>
    case 'zap':
